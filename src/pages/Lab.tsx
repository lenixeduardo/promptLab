...
const HEADER_INFO: Record<LabTab, { title: string; subtitle: string }> = {
  skills: {
    title: "Laboratório de Skills",
    subtitle: "80+ skills reais para potencializar sua IA",
  },
  prompts: {
    title: "Laboratório de Prompts",
    subtitle: "Copie, adapte e use prompts da comunidade",
  },
  templates: {
    title: "Laboratório de Templates",
    subtitle: "Estruturas prontas para você partir na frente",
  },
}
    ...
    <div>
      ...
      {filter === "todas" && !search.trim() && superpowers.length > 0 && (
        <div className="mb-5 rounded-2xl border border-yellow-200 bg-gradient-to-br from-yellow-50 to-amber-50 p-4 dark:border-yellow-900/40 dark:from-[#1E2D0F] dark:to-[#1A2A0E]">
          ...
          <p className="mb-3 text-xs text-foregroundMuted">
            Skills curadas com instalação 1-clique
          </p>
      ...
      {filtered.length === 0 && search.trim() && (
        <div className="flex flex-col items-center gap-2 py-10 text-center">
          ...
          <p className="text-sm font-semibold text-foregroundDark dark:text-white">
        ...
        {filtered.map((skill) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-bold text-foregroundDark dark:text-white">
                {skill.name}
              </p>
    ...
    <div className="min-h-screen bg-white pb-24 lg:pb-8 dark:bg-pageBg">
      ...
      <div className="sticky top-0 z-10 bg-white px-4 lg:px-8 pb-0 pt-6 lg:pt-8 dark:bg-pageBg">
        <div className="lg:max-w-5xl lg:mx-auto">
          <h1 className="text-2xl lg:text-3xl font-extrabold text-foregroundDark dark:text-white">
            {title}
          </h1>
          <p className="mt-0.5 text-sm lg:text-base text-[#3E6B50] dark:text-foregroundMuted">
            {subtitle}
          </p>
