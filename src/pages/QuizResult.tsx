  ...
  return (
    <div className="relative flex items-center justify-center" style={{ width: 140, height: 140 }}>
      <svg width="140" height="140" className="-rotate-90">
        <circle cx="70" cy="70" r={radius} fill="none" stroke="#E0F3E9" strokeWidth="10" />
        <circle
          cx="70"
          cy="70"
          r={radius}
...
export default function QuizResult() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center overflow-hidden bg-white px-5 pb-10 pt-8">
      ...
      <Sparkles
        className="absolute left-6 top-20 h-5 w-5 animate-twinkle text-emerald/60"
        style={{ animationDelay: "0.3s" }}
      />
      <Sparkles
        className="absolute right-8 top-28 h-4 w-4 animate-twinkle text-[#7CC79A]"
        style={{ animationDelay: "1s" }}
      />
      <Sparkles
        className="absolute left-10 top-52 h-3 w-3 animate-twinkle text-[#FFD166]"
        style={{ animationDelay: "1.7s" }}
      />
      <Sparkles
        className="absolute right-6 top-64 h-5 w-5 animate-twinkle text-emerald/50"
        ...
        {isPerfect && (
          <div className="mt-4 flex w-full items-center gap-2 rounded-2xl border border-[#FFD166] bg-[#FFFBEA] px-4 py-3 shadow-sm">
            ...
            <p className="text-sm font-semibold text-[#92600A]">
              Nova skill liberada! <span className="font-bold text-emerald">Certificado</span>
            </p>
          </div>
        )}
